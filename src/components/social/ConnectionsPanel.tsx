...
function SentInvitationCard({
  ...
  return (
    <article className="rounded-md border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-900/70">
      <Link
        className="inline-block max-w-full truncate text-lg font-bold text-slate-950 transition hover:text-teal-700 focus-visible:rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-200 dark:text-white dark:hover:text-teal-200"
      ...
      <div className="mt-4 flex flex-wrap items-center gap-2">
        <span className="inline-flex rounded-md bg-amber-50 px-3 py-2 text-sm font-bold text-amber-800 dark:bg-amber-400/10 dark:text-amber-200">
          Pending
        </span>
        <button
          className="btn btn-secondary btn-sm"
